...
public class EnchanterContainer extends Container {
	...
	public final EnchanterTileEntity tile;
	
	public EnchanterContainer(final int windowId, final PlayerInventory playerInventory, final PacketBuffer data) {
		this(windowId, playerInventory, getTileEntity(playerInventory, data));
	}
	
	public EnchanterContainer(final int windowId, final PlayerInventory playerInventory, final EnchanterTileEntity tile) {
		super(EEContainerTypes.ENCHANTER.get(), windowId);
		this.tile = tile;
	...
	private static EnchanterTileEntity getTileEntity(final PlayerInventory playerInventory, final PacketBuffer data) {
		Objects.requireNonNull(playerInventory, "playerInventory cannot be null!");
		Objects.requireNonNull(data, "data cannot be null!");
		final TileEntity tileAtPos = playerInventory.player.world.getTileEntity(data.readBlockPos());
		if (tileAtPos instanceof EnchanterTileEntity)
			return (EnchanterTileEntity) tileAtPos;
