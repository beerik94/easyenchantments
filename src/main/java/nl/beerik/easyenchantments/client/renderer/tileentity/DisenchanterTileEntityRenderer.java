...
public class DisenchanterTileEntityRenderer extends TileEntityRenderer<DisenchanterTileEntity> {

	public DisenchanterTileEntityRenderer(final TileEntityRendererDispatcher tileRendererDispatcher) {
		super(tileRendererDispatcher);
	}

	@SuppressWarnings("deprecation")
	@Override
	public void render(final DisenchanterTileEntity tileEntityIn, final float partialTicks, final MatrixStack matrixStack, final IRenderTypeBuffer renderTypeBuffer, final int packedLight, final int backupPackedLight) {
