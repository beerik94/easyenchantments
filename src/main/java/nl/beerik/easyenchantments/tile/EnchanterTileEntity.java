...
public class EnchanterTileEntity extends TileEntity implements INamedContainerProvider {
	...
	public EnchanterTileEntity() {
		super(EETileEntityTypes.ENCHANTER.get());
	}
	...
	public Container createMenu(final int windowId, final PlayerInventory inventory, final PlayerEntity player) {
		return new EnchanterContainer(windowId, inventory, this);
	}

	@Override
	public ITextComponent getDisplayName() {
		return new TranslationTextComponent(EEBlocks.ENCHANTER.get().getTranslationKey());
	}
